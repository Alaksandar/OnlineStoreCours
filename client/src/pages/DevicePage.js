...
const DevicePage = () => {
    ...
    const description = [
        {id: 1, title: 'Dimensions', description: '131.5 x 64.2 x 7.4 mm (5.18 x 2.53 x 0.29 in)'},        {title: 'OS', description: 'iOS 14.1, upgradable to iOS 16.2'},
        ...
        {id: 6, title: 'OS', description: 'iOS 14.1, upgradable to iOS 16.2'},
    ]
